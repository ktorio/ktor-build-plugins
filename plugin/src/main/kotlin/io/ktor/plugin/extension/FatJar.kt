...
const val BUILD_FAT_JAR_EXTENSION_NAME = "fatJar"
    ...
    val configureShadowJar = tasks.register("configureShadowJar") {
        it.doLast {
            if (project.findProperty("mainClassName") == null) {
                project.extensions.findByType(JavaApplication::class.java)?.let { application ->
