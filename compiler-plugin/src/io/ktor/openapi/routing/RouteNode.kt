...
sealed interface RouteNode: SourceCoordinates {
    ...
    val functionName: String get() = fir.calleeReference.name.asString()
    ...
    class Route(
        ...
        override fun toString(): String = buildString {
            append(fir.calleeReference.name.asString())
    ...
    class Function(
        ...
        override fun toString(): String =
            fir.calleeReference.name.asString() + '@' + fir.source?.range
