...
fun Application.responses() {
    ...
    routing {
         ...
         * @response 200 Plain JSON text response
         */
        get("/json") {
         ...
         * @header X-Question Question about life
         */
        get("/binary") {
         ...
         * @header Content-Disposition File attachment
         */
        get("/file") {
        ...
        route("/complex") {
             ...
             *   maximum: 100
             *   default: 10
             * @response 200 [PaginatedResponse<Dude>] Paginated dudes
             */
            get("/paginated") {
